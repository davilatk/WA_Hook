...
The code here mirrors what is in our [webhook set up guide](https://developers.facebook.com/docs/messenger-platform/getting-started/webhook-setup), and may be used as the starting point for doing the [WhatsApp Business Platform quick start tutorial](https://developers.facebook.com/docs/whatsapp/getting-started/signing-up/).
